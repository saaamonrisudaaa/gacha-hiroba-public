/* ===========================================================================
   新作ガチャの発売情報
   ★ トップページの「今週・近日発売の新作」と新着情報ページに使われます。
      date: 'YYYY-MM-DD'（発売日または週単位告知の代表日）。トップページと
      新着情報ページでは、当日・今後の予定・最近発売の順で最大7件を表示します。
      古い項目は公式情報の確認後に整理します。
   ★ source は必ず一次情報（メーカー公式・公式ニュースリリース）を入れてください。
      公式画像は転載せず、商品名と確認できた事実だけを短く掲載します。
   ★ 任意フィールド
      label: バッジの表記を上書きする（例 '9月第2週より順次'）。具体的な日付を
             公表していない商品はメーカーの表記を保ち、date は並び順と月別ページ
             の判定にだけ使います。
